...
- name: Expedia Create A Trip
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/travel/master/_listings/expedia/api-packages-createtrip-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/travel/master/_listings/expedia/api-packages-createtrip-post-postman.md
x-common:
- type: x-base
